...
<html>
    ...
    <font face="Verdana">
        ...
        <h3>Want to request a vehicle evaluation?</h3>
        Any individual or organisation who wishes to request evaluation of a certain vehicle model is welcome to do so by contacting the page administrator <a href="mailto:theyawningchihuahua@gmail.com">via email</a> with the following details:
        <ul>
        ...
        No reason is required for nominating the model; however, please note that all editorial control, including the final decision to select the vehicle or not, rests with the page administrator.
