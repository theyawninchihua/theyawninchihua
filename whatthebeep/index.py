...
<html>
    ...
    <font face="Verdana">
        ...
        Selection of vehicle models for evaluation is at the sole discretion of the page administrator of <i>The Yawning Chihuahua</i>. In general principle, in order to be evaluated, the vehicle must:
        <ul>
            <li>be classified as M1/N1</li>
            <li>be on sale in the Indian market (local homologation, however, is <b>not</b> required</li>
            <li>have a second row of seats</li>
        </ul>
        <b>If you would like a specific model to be considered for evaluation, please send a request to <i>The Yawning Chihuahua</i> <a href="mailto:theyawningchihuahua@gmail.com">via email</a> or <a href="https://x.com/theyawninchihua">on Twitter</a> with:
        <ul>
            <li>the vehicle model name</li>
            <li>declaration that you are not professionally affiliated with a vehicle manufacturer, except the manufacturer of the vehicle being nominated</li>
            <li>declaration that you are not professionally affiliated with a vehicle component supplier</li>
        </ul>
        However, please note that, due to time and resource constraints, it is not guaranteed that requests will be honoured. Requested evaluations are likely to be desktop evaluations.</b><br>
        ...
        <font face="Courier New">
            <table border="1">
            <tr>
                <th colspan="3"><font color="green">PASS criteria for #WhatTheBeep</font></th>
            </tr>
            <tr>
        ...
        If you're a journalist looking to report on <i>#WhatTheBeep</i> evaluations, you are more than welcome to do so! A few requests:
        <ul>
            <li> please consider mentioning that <i>#WhatTheBeep</i> is an <b>independent, informal assessment</b> of rear seatbelt reminder behaviour</li>
